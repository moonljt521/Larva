...
public class Larva {
    ...
    private static class LarvaHolder {
        static final Larva INSTANCE = new Larva();
    }

    public static Larva getInstance(){
        return LarvaHolder.INSTANCE;
    }
     ...
     * @param dstHeight
     */
    public void load(Context context,final String url, final ImageView imageView, final int dstWidth, final int
            dstHeight) {
        if (!isLoad){
            init(context);
            isLoad = true;
     ...
     * @param imageView
     */
    public void load(Context context,final String url, final ImageView imageView) {
